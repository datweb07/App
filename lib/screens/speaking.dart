...
class _SpeakingState extends State<Speaking> {
  ...
  void _getUserStatus() async {
    final status = await blindService.getLastSeenTime(widget.receiverID);
    setState(() {
      _userStatus = status;
    });
  }
    ...
    try {
      ...
      if (userDoc.exists) {
        ...
        setState(() {
          ...
          _canSendMessage = userType == 'blind';
  ...
  void senMessage() async {
    if (messageController.text.isNotEmpty) {
      ...
      // Send message
      await blindService.sendMessage(widget.receiverID, messageText);
                      ...
                      IconButton(
                        ...
                        onPressed: () {
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text(
                                "Tính năng gọi điện đang phát triển",
                              ),
                            ),
                          );
                        },
  ...
  Widget messageList() {
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 8),
            Text(
              "Bạn chỉ có thể nhắn tin với người dùng khiếm thị",
    ...
    return StreamBuilder(
      stream: blindService.getMessages(widget.receiverID, senderID),
      builder: (context, snapshot) {
        ...
        WidgetsBinding.instance.addPostFrameCallback((_) {
          blindService.markMessagesAsRead(senderID, widget.receiverID);
        });
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return messageItem(doc, index, snapshot.data!.docs);
          },
        );
      },
    );
          ...
          children: [
            ...
            if (_receiverUserType.isNotEmpty) ...[
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: _receiverUserType == 'blind'
                      ? Colors.blue
                      : Colors.grey,
                  borderRadius: BorderRadius.circular(16),
                ),
                child: Text(
                  _receiverUserType == 'blind' ? 'Khiếm thị' : 'Khiếm thính',
                  style: TextStyle(
                    color: Colors.white,
                    fontSize: 12,
                    fontWeight: FontWeight.bold,
