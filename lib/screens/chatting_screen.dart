...
// import 'package:demo_nckh/services/authentication/search_delegate.dart';
...
//                   showSearch(
//                     context: context,
//                     delegate: UserSearchDelegate(chattingService),
//                   );
//                 },
//               ),
...
class _ChattingScreenState extends State<ChattingScreen> {
  ...
  Widget conversationListItem(
    ...
    final lastSeen = conversationData["lastSeen"] as Timestamp?;
    ...
    if (lastMessageTime != null) {
      ...
      if (difference.inDays > 0) {
        timeString = "${difference.inDays} ngày";
      } else if (difference.inHours > 0) {
        timeString = "${difference.inHours} giờ";
      } else if (difference.inMinutes > 0) {
        timeString = "${difference.inMinutes} phút";
      } else {
        timeString = "Vừa xong";
      }
    }
        ...
        children: [
          CircleAvatar(
            ...
            child: conversationData["photoURL"] == null
                ? Text(
                    conversationData["email"]?.substring(0, 1).toUpperCase() ??
                        "U",
